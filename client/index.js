(function(){
  ...
  angular.module('knipit', ['ngRoute', ,'ngAnimate', 'LocalForageModule', 'ui.gravatar', 'iso.directives'])
  ...
  .config(['$routeProvider', '$httpProvider', '$localForageProvider', function($routeProvider, $httpProvider, $localForageProvider){
    ...
    .when('/leaderboards', {templateUrl:'/views/leader/leader.html', controller:'LeaderCtrl'})
    ...
    .when('/challenge/:deckId/:isChallenger/:challengeId', {templateUrl:'/views/challenge-mode/chal-mode.html', controller:'ChallengeCtrl'})
